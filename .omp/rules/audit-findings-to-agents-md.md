...
condition: ["fix\\((?:Lang|TimeTicks|Misc|Instruments|Instances|Collections|OrderTypes|Ccxt|ExchangeTypes|Exchanges|Fetch|Watchers|Cli|Data|Processing|Strategies|Metrics|Pbar|Stubs|Opt|Plotting|Remote|Engine|Planar|PlanarDev|PlanarOptim|PlanarPython|PlanarFeatureSelection|PlanarStrategyTools|PlanarStrategyStats|PlanarDownloadTool)\\): .*", "Audit .* found .* bug", "root-cause fix"]
scope: "text"
---
