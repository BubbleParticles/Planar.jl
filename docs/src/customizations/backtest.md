...
The `SimMode` class, also known as the planar backtester, utilizes Open-High-Low-Close-Volume ([OHLCV](../guides/../guides/../guides/data-management.md#ohlcv-data)) data to simulate the execution of trades.
...
#### [OHLCV](../guides/../guides/../guides/data-management.md#ohlcv-data)-Based Approach
- A simpler method involves using the [OHLCV](../guides/../guides/../guides/data-management.md#ohlcv-data) model with extremely short-duration candles, such as `1s` candles. The backtester processes time steps, typically using the [strategy](../guides/../guides/strategy-development.md)'s base [timeframe](../guides/../guides/../guides/data-management.md#timeframes). By selecting a `1s` [timeframe](../guides/../guides/../guides/data-management.md#timeframes) and supplying the corresponding candles, you can achieve the desired time resolution for your [backtest](../guides/execution-modes.md#simulation-mode).
