...
using PlanarCore.Executors.TimeTicks: DateTime, Day, Second, DateRange, TimeFrame
using PlanarCore.Executors.Misc: Sim
using PlanarCore.Executors.Misc: Long, Short, DFT

# Access Instances through Executors for mock setup
using PlanarCore.Executors.Instances.Instruments: @a_str
using PlanarCore.Executors.Instances.DataStructures: SortedDict
using PlanarCore.Executors.Instances.Data: DataFrame
using PlanarCore.Executors.Instances.TimeTicks: @tf_str
using PlanarCore.Executors.Instances.Misc: NoMargin
...
@testset "Executors" begin
    ...
    @testset "positions/state pure functions" begin
        @testset "_buffered" begin
            using PlanarCore.Executors.Misc: Long, Short
            price = 100.0
