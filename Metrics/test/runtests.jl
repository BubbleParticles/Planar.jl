...
@testset "trades_stats does not mutate live history" begin
    cfg = Metrics.Instances.Misc.Config()
    using Stubs: stub_strategy
    using Metrics.Instances: AssetInstance
    using Metrics.Instances.Instruments: AbstractAsset, parse
    using Metrics.Instances.Misc: NoMargin
    using Metrics.Instances.Exchanges.ExchangeTypes: ExchangeID
    using Metrics.OrderTypes: Order, Trade, MarketOrderType, Buy
