...
function test_processing()
    ...
    @testset "Processing.upsample" begin
        ...
        @test_throws AssertionError Processing.upsample(df1, tf_bad, tf_small)
        ...
        @test_throws AssertionError Processing.upsample(df_zero, tf_large, tf_small)
        tf_small = TimeFrame(Minute(1))
        ...
        Processing.upsample(df1, tf_large, tf_small)
