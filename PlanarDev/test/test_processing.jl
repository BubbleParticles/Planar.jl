...
function test_processing()
    ...
    @testset "Processing.upsample" begin
        ...
        result_nonmono = proc.upsample(df_nonmono, tf_large, tf_small)
        ...
        result_dup = proc.upsample(df_dup, tf_large, tf_small)
        ...
        result_large = proc.upsample(df_large, tf_large, tf_small)
