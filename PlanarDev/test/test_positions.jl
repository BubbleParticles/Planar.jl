...
macro position_constructor(side=Planar.Engine.Misc.Long, mm=Planar.Engine.Misc.Isolated)
    e = quote
        eid = :binance
        ...
        pos = Planar.Engine.Instances.Position{$side,PlanarDev.Planar.ExchangeTypes.ExchangeID{eid},$mm}(;
            asset,
            min_size=0.0,
            tiers=[tiers],
...
function test_positions()
    ...
    @testset "positions" begin
        try
            ...
            Base.invokelatest(test_maxleverage_function)
            Base.invokelatest(test_status_function)
            Base.invokelatest(test_isopen_function)
            Base.invokelatest(test_islong_and_isshort_functions)
            ...
            Base.invokelatest(test_tier_bang_function)
            Base.invokelatest(test_entryprice_bang_function)
            Base.invokelatest(test_notional_function)
            Base.invokelatest(test_margin_and_related_functions)
            Base.invokelatest(test_maintenance_function)
            Base.invokelatest(test_cash_and_commit_functions)
            Base.invokelatest(test_pnl_functions)
            Base.invokelatest(test_updated_functions)
            Base.invokelatest(test_pnl_long_function)
            Base.invokelatest(test_pnl_short_function)
            Base.invokelatest(test_pnl_calculation_functions)
            Base.invokelatest(test_liqprice_functions)
            Base.invokelatest(test_liqprice_long_function)
            Base.invokelatest(test_liqprice_short_function)
            Base.invokelatest(test_position_updated_function)
            Base.invokelatest(test_margin_updated_function)
